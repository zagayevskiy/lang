...
//        p("main{;}", LangUndefined.INSTANCE);
        p("main { 2 + 3 * (1 - 17 + (1 << 1) * 2) - 22; }", LangInteger.from(2 + 3 * (1 - 17 + (1 << 1) * 2) - 22));
        p("main {var a = 1, b = 2, c = 7, x = a, z = b, y = c;} ", LangInteger.from(7));
        p("main { var x, y, z=123, t, qwerty = 971,\n asdf=345; var g, h, k; \n var temp = qwerty; }", LangInteger.from(971));
        p("main { 1; var x = 2; var y = (x + 1), z = y + 2;  x * 10; var result = x<<y<<z<<4; }", LangInteger.from(2<<3<<5<<4));

...
public class Programs {
    ...
    static {
        ...
        p("main { var x = 123; x->subString(1, 2); }", LangUndefined.INSTANCE);
        ...
        p("class Point{ var x = 0, y = 0; method n(c) { c; } method m(a, b) {self->n(a + b); } Point (x, y) { ; } } main { var x = new Point(); x->m(5, 10); }", 15);
    }

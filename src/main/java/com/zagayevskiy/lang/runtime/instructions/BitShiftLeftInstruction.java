...
public class BitShiftLeftInstruction extends AbsBinaryInstruction {

    public static final BitShiftLeftInstruction INSTTANCE = new BitShiftLeftInstruction();

    private BitShiftLeftInstruction() {
